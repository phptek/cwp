...
class CwpSearchBoostExtension extends DataExtension
{
	...
	// @todo @upgrade
        ...
        $boostDescription = _t(
                'CwpSiteTreeSearchBoost.SearchBoostDescription', 'Enter keywords separated by comma ( , ) for which to boost the ranking of this page within the search results on this site.'
        );
